function scr_player_Sjumpprep() //scr_player_Sjumpprep
{
    ...
    if (floor(image_index) == (image_number - 1) && sprite_index == spr_superjumpprep)
        sprite_index = spr_superjumppreplight
    if ((!key_up) && (character == "S" || sprite_index == spr_superjumppreplight || sprite_index == spr_superjumpleft || sprite_index == spr_superjumpright) && (!(scr_solid(x, (y - 16)))) && (!(scr_solid(x, (y - 32)))) && grounded)
    {
