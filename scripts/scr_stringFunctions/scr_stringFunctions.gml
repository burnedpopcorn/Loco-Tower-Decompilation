...
function string_contains(argument0, argument1) //string_contains
{
...
function string_startswith(argument0, argument1) //string_startswith
{
    if (string_length(argument1) > string_length(argument0))
        return 0;
...
function string_endswith(argument0, argument1) //string_endswith
{
    if (string_length(argument1) > string_length(argument0))
        return 0;
