...
{
	draw_sprite(obj_player1.sprite_index,obj_player1.image_index,60,470)
	draw_set_font(global.smallerfont)
	draw_set_color(c_white)
	draw_set_halign(fa_left)
	draw_text(32,136,"Image_index: " + string(obj_player1.image_index))
	draw_text(32,168,"Image_speed: " + string(obj_player1.image_speed))
	draw_text(32,200,"X: " + string(obj_player1.x))
	draw_text(32,232,"Y: " + string(obj_player1.y))
	draw_text(32,264,"Movespeed: " + string(obj_player1.movespeed))
	draw_text(32,298,"HSP: " + string(obj_player1.hsp))
	draw_text(32,330,"VSP: " + string(obj_player1.vsp))
	draw_text(32,362,"State: " + string(obj_player1.state))
	draw_text(32,394,"Sprite: " + string(obj_player1.sprite_index))
}
