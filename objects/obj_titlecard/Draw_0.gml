if start
{
    draw_sprite(titlecard_sprite, -1, camera_get_view_x(view_camera[0]), camera_get_view_y(view_camera[0]))
    var s = 1
    draw_sprite(title_sprite, -1, (camera_get_view_x(view_camera[0]) + irandom_range((-s), s)), (camera_get_view_y(view_camera[0]) + irandom_range((-s), s)))
}
